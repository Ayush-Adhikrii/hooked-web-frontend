		...
		`}
			>
				<div className='flex flex-col h-full bg-pink-200'>
					{/* Header */}
					<div className='p-4 pb-[27px] border-b border-pink-200 bg-pink-300 rounded-lg flex justify-between items-center'>
					...
					<div className='flex-grow overflow-y-auto p-4 z-10 relative bg-pink-200 '>
						{isLoadingMyMatches ? (
							<LoadingState />
						) : matches.length === 0 ? (
							<NoMatchesFound />
